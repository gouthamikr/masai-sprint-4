...
export default class Cart extends Component {
      ...
      .then(() => {
        if (this.state.data.length > 0) {
          ...
          for (let z = 0; z < this.state.data.length; z++) {
            sum += Number(this.state.data[z].quantity)
              ? Number(this.state.data[z].item.cost) *
                Number(this.state.data[z].quantity)
              : Number(this.state.data[z].item.cost) * 1;
            console.log(sum);
            console.log(
              Number(this.state.data[z].item.cost),
              "cost",
  ...
  handleCoupon = () => {
    alert("Oops! No coupons available!");
  };
  render() {
    console.log(this.state.data);
    return (
      <>
        <div style={{ marginLeft: "14%", lineHeight: 1.5, display: "flex" }}>
              ...
              <>
                ...
                >
                  <div className="d-flex mt-2">
                    ...
                    <div className="flex-1" style={{ marginLeft: "36%" }}>
                      <div style={{ fontWeight: "bold", fontSize: "20px" }}>
                        Price : $
                        {a.quantity
                          ? a.quantity * a.item.cost
                          : 1 * a.item.cost}
                      </div>
                      <div>
                        <span
